...
public class ExternalPortal extends TestBase {
	...
	String path= "C:\\Users\\ShahrukhAata_l4\\Project\\Test\\TestData\\ExternalPortal.xls";
...
driver.get(url);
	...
	public void TestCase16() throws Exception  {
		 test1 = extent.createTest("Test Case16", "NucleusTestCase ");
		try {
			System.out.println("TestCase started 16");
		ArrayList data=d.getData("TestCase16",path);
		String url = (String) data.get(2);
		String Username= (String) data.get(3);
		String Password= (String) data.get(4);
		String CompanyName=(String) data.get(5);
	...
	public void TestCase17() throws Exception  {
		 test1 = extent.createTest("Test Case17", "NucleusTestCase ");
		try {
			System.out.println("TestCase started 17");
		ArrayList data=d.getData("TestCase17",path);
		String url = (String) data.get(2);
		String Username= (String) data.get(3);
		String Password= (String) data.get(4);
		String CompanyName=(String) data.get(5);
	...
	public void TestCase18() throws Exception  {
		 test1 = extent.createTest("Test Case18", "NucleusTestCase ");
		try {
			System.out.println("TestCase started 18");
		ArrayList data=d.getData("TestCase18",path);
		String url = (String) data.get(2);
		String Username= (String) data.get(3);
		String Password= (String) data.get(4);
		String CompanyName=(String) data.get(5);
	...
	public void TestCase19() throws Exception  {
		 test1 = extent.createTest("Test Case19", "NucleusTestCase ");
		try {
			System.out.println("TestCase started 19");
		ArrayList data=d.getData("TestCase19",path);
		String url = (String) data.get(2);
		String Username= (String) data.get(3);
		String Password= (String) data.get(4);
		String CompanyName=(String) data.get(5);
	...
	public void TestCase20() throws Exception  {
		 test1 = extent.createTest("Test Case20", "NucleusTestCase ");
		try {
			System.out.println("TestCase started 20");
		ArrayList data=d.getData("TestCase20",path);
		String url = (String) data.get(2);
		String Username= (String) data.get(3);
		String Password= (String) data.get(4);
		String CompanyName=(String) data.get(5);
	...
	public void TestCase21() throws Exception  {
		 test1 = extent.createTest("Test Case21", "NucleusTestCase ");
		try {
			System.out.println("TestCase started 21");
		ArrayList data=d.getData("TestCase21",path);
		String url = (String) data.get(2);
		String Username= (String) data.get(3);
		String Password= (String) data.get(4);
		String CompanyName=(String) data.get(5);
